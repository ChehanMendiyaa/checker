	  ...
	  <div class="uk-container">
	    <div data-uk-navbar>
	      <div class="uk-navbar-left">
	        <a class="uk-navbar-item uk-logo uk-visible@m" href="https://t.me/badboy_checkers">BADBOY CHK</a>
	      ...
	      <div class="uk-navbar-center uk-hidden@m">
	        <a class="uk-navbar-item uk-logo" href="https://t.me/badboy_checkers">BADBOY CHK</a>
	      </div>
	      <div class="uk-navbar-right">
	        <ul class="uk-navbar-nav uk-visible@m">
	          <li ><a href="index.html">sk base</a></li>
	          ...
	          <li>
                ...
                <?php if($userLogged === true) { ?>
	              <a class="uk-button uk-button-small uk-button-primary-outline logoutbtn" href="./logout?destroy=sesssion_destroy">TELEGRAM</a>
	            <?php } else { ?>
